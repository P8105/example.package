...
sim_regression(n = 3000, beta0 = 2, beta1 = 3)
```
...
```{r}
sim_results = 
  simulate_nruns(n_runs = 100, sim_func = sim_regression,
                 n = 30, beta0 = 2, beta1 = 3)
...
```{r}
sim_results = 
  simulate_nruns(n_runs = 100, sim_func = sim_bern_mean,
                 n = 30, prob = .95)
